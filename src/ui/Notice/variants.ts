...
export const progressBarVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        info: ['bg-[var(--notice-progress-info)]'],
        success: ['bg-[var(--notice-progress-success)]'],
        warning: ['bg-[var(--notice-progress-warning)]'],
        error: ['bg-[var(--notice-progress-error)]']
      }
    },
    defaultVariants: {
      variant: 'info'
